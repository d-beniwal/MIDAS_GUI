...
_Last updated: 2026-09-25 (Zarr Viewer tab, live-verified; real ion-chamber/
sample-motor metadata in Batch's zarr output; polarization plane + lab-frame
conventions; merged upstream Mask Builder folder/multi-frame Image +
threshold projection, and Data Viewer folder-format filter/scrubber/
profile-file + app-wide frame-nav slider styling)_
