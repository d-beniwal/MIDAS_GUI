...
Vendored — see ``midas_gui/_vendor/frozen_point_calib/__init__.py`` for
provenance and why this lives here instead of in ``midas_calibrate_v2``.
"""
...
from midas_calibrate_v2.forward.distortion import P_COEF_NAMES, resolve_distortion_block
from midas_calibrate_v2.inference.lm import GenericLMConfig, lm_minimise
...
# _filter_by_snr lives on midas_calibrate_v2.pipelines.single_pv in the
# 0.17.0 baseline this was vendored against; a later upstream merge of the
# real frozen-point pipeline promotes it to pipelines._common instead — see
# this package's __init__.py for the version this was checked against.
from midas_calibrate_v2.pipelines.single_pv import (
    IterRecord, PVCalibrationResult, _filter_by_snr,
)

from .point_pick import PickedPoints, pick_points
