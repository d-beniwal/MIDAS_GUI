...
class CalibrationTab(QtWidgets.QWidget):
    ...
    @staticmethod
    def _paramstest_pairs(result, selected=None):
        ...
        import os, tempfile
        from pathlib import Path
        from midas_gui.helpers import write_standalone_paramstest, _PARAMSTEST_DISTORTION
    ...
    def _on_done(self, result):
        ...
        try:
            self._populate_param_grid(
                self._paramstest_pairs(result, selected=self._last_dist_coeffs))
        except Exception:
